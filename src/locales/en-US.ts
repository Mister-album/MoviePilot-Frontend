export default {
  ...
  dialog: {
    ...
    reorganize: {
      ...
      previewSourceColumn: 'Source',
      previewTargetColumn: 'Target',
      previewTargetDirColumn: 'Target Dir',
      previewMediaColumn: 'Media',
      previewEpisodeColumn: 'Episode Info',
      previewStatusColumn: 'Status',
